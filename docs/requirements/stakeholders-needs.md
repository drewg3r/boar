...
|Керівник групи|Керівник команди розробників. Займається розподілом завдань в команді, слідкує за ходом виконання і бере на себе відповідальність за технічну складову проекту.|Висококваліфікований програміст, знає як керувати іншими програмістами та планувати задачі.|Взаємодіє з розробником, тестувальником та менеджером проєкту.|
...
***НАЗВА:*** Замовити систему

***УЧАСНИКИ:*** Замовник, проектний менеджер
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
                         ...
                         1.Замовник висуває проектний менеджер свої вимоги до системи (EХ.001.001)
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
                     ...
                     1. Проектний менеджер демострує розроблену систему 
                     
                     2.Замовник отримує замовлену систему(EХ.001.003)
...
***НАЗВА:*** Передати сформоване замовником завдання до керівника групи

***УЧАСНИКИ:***  Проектний менеджер, керівник групи

***ПЕРЕДУМОВИ:*** Керівник групи не знає завдання
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
                     ...
                     1. Проектний менеджер передає замовлення керівнику групи (EX01.02)

                     2. Керівник групи оцінює об’єм та характер роботи, формує завдання (EХ.002.001, EХ.002.002)
                     
                     3. Керівник групи готовий до розподілу завдань серед розробників
...
***НАЗВА:*** Передати виконане завдання до проектного менеджера

***УЧАСНИКИ:***  Проектний менеджер, керівник групи

***ПЕРЕДУМОВИ:*** Завдання має бути передано на відповідність  щодо поставлених замовником умов та функціональної  якості до проектного менеджера

***РЕЗУЛЬТАТ:*** Працююча замовлена система 
...
***ОСНОВНИЙ СЦЕНАРІЙ:***
                    ...
                    1. Керівник групи передає виконане командою розробників та тестувальників завдання до проектного менеджера (EХ.002.005)
                    
                    2. Проектний менеджер оцінює якість виконаної роботи (EХ.002.003, EХ.002.004)

                    3. Проектний менеджер готовий до передачі системи замовникові
...
***НАЗВА:***  Керівник групи дає завдання розробнику

***УЧАСНИКИ:***  Керівник групи, розробник

***ПЕРЕДУМОВИ:***  Керівник групи має завдання
...
***ОСНОВНИЙ СЦЕНАРІЙ:***
                    ...
                    1. Керівник групи виходить на зв’язок з розробником
                    
                    2. Керівник групи пояснює завдання розробнику(EХ.003.001)
...
***ПЕРЕДУМОВИ:*** Керівник групи не задоволений виконаною роботою

***РЕЗУЛЬТАТ:*** Керівник групи пояснив розробнику що слід змінити
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
                     ...
                     2. Керівник групи пояснює розробнику що потрібно змінити(можливо EХ.003.001, EХ.003.003)
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
                     ...
                     2. Керівник групи пояснює завдання розробнику(можливо EХ.004.001)
...
***НАЗВА:*** Керівник групи не прийняв роботу розробника
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
                     ...
                     2. Керівник групи пояснює розробнику що потрібно змінити(можливо EХ.004.002, EХ.004.003)
...
***ОСНОВНИЙ СЦЕНАРІЙ:***
                     ...
                     Тестувальник отримав ревю від розробника і провертає його. У випадку непрацездатності продукту, тестувальник відправляє назад ревю розробнику з вказівками на помилки
...
***РЕЗУЛЬТАТ:*** Тестувальник відправляє ревю керівнику групи на перевірку коректності
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
                     ...
                     Тестувальник перевірив продукт на працездатність. Тестувальник відправляє керівнику групи на перевірку коректність ревю (EХ.005.002)
